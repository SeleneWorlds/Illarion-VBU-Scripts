...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist die Anwärterin Zaida. Schlüsselwörter: Seid gegrüßt, Beruf, Taverne."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Neues Quest] Die Schwätzerin von Runewick"))
talkEntry:addConsequence(consequence_quest(76, "=", 1))
