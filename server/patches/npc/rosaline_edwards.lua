...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Königin Rosaline Edwards von Cadomyr. Schlüsselwörter: Es lebe die Königin, Cadomyr, Feinde, Sir Reginald, Gruft, Grab."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger(".*")
talkEntry:addCondition(condition_town(1))
talkEntry:addConsequence(consequence_inform("[Quest 'Finde Königin Rosaline Edwards' Ende]"))
talkEntry:addConsequence(consequence_deleteitem(144, 1, nil))
talkEntry:addConsequence(consequence_quest(642, "=", 2))
talkEntry:addConsequence(consequence_rankpoints("+", 2))
talkEntry:addResponse("Oh, Blumen! Aber glaubt nicht, dass ihr damit meine Gunst gewinnen könnt, auch wenn ich euren Versuch dieses Mal durchgehen lassen werde.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Queststatus] Die Erinnerung V: Du überbringst Königin Rosaline Edwards die Nachricht von Groktan Flintsplit."))
talkEntry:addConsequence(consequence_quest(107, "=", 13))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(701, "=", 13))
talkEntry:addCondition(condition_item(225, "all", ">", 0, {["descriptionDe"] = "Diese Krone gehört Rosaline Edwards."}))
talkEntry:addTrigger("Zassaria")
...
talkEntry:addTrigger("riverbank")
talkEntry:addTrigger("Nachricht")
talkEntry:addConsequence(consequence_deleteitem(225, 1, {["descriptionDe"] = "Diese Krone gehört Rosaline Edwards."}))
talkEntry:addConsequence(consequence_quest(701, "=", 14))
...
talkingNPC:addCycleText("Wo ist Hassan schon wieder! Schickt nach meinem Fächerwedler, mir ist heiß!", "Where is Hassan again? Send word to my fan waver, it is hot!")
...
talkingNPC:addCycleText("Wer hat da ein Licht auf dem Fenstersims entzündet? Was geht nur wieder in diesem Palast vor sich.", "This candle in the window? Who lit that?")
