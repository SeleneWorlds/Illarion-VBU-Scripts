...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Schmuggler Cormac. Schlüsselwörter: Seid gegrüßt, Beruf, Taverne."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Neues Quest] Der Schwätzer von Galmair"))
talkEntry:addConsequence(consequence_quest(74, "=", 1))
...
talkEntry:addCondition(condition_town(3))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Cormac wird nun deine Fragen beantworten."))
talkEntry:addConsequence(consequence_deleteitem(1909, 1, nil))
talkEntry:addConsequence(consequence_quest(74, "=", 2))
talkEntry:addConsequence(consequence_rankpoints("+", 2))
