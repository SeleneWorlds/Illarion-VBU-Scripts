...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Iradona Goldschein die Auskunftgeberin. Schlüsselwörter: Auskunft, Information, Galmair, Gebäude, Spielraum, Auftrag, Stadt."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Der Tempel des Nargun in der Schimmersenke ist ein Ort für jene die Nargun folgen. Klar, oder?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Schlüsselwörter] Markt, Tempel, Teleporter, Eselstall, Bibliothek, Quelle der Träume, Villa Goldader, Werkstatt, Wachstube, Dunkle Gasse, Galmairs Krone, Schlackengrube"))
talkEntry:addResponse("Argh, etwas genauer! Markt, Tempel, Teleporter, Eselstall, Bibliothek, Quelle der Träume, Villa Goldader, Werkstatt, Wachstube, Dunkle Gasse, Galmairs Krone oder die Schlackengrube?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Schlüsselwörter] Hinterland, Lotta Medborgar"))
talkEntry:addResponse("Ich empfehle, dass du nach Lotta Medborgar suchst, wenn du mehr über das Hinterland wissen möchtest. Sie ist eine Jägerin und hat etliche Orte erkundet. Frag sie daher besser. Du kannst sie unten in der Taverne zur Geflügelten Sau finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Sie ist eine Jägerin und hat etliche Orte in Illarion erkundet. Unter anderem den Sumpf, Nördliche Wälder, Nargun Ebene, Gasthof zur Hanfschlinge, Grenzstrom, Malachit Bach und so weiter. Du kannst sie unten in der Taverne zur Geflügelten Sau finden.")
talkEntry:addConsequence(consequence_quest(630, "=", 1))
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
talkEntry:addResponse("Die Geschichte unserer Stadt kannst du in unserer Bibliothek nachlesen. Leider ging das eigentliche Geschichtsbuch verloren. Aber der Don war so nett und hat uns seine persönlichen Notizen zur Verfügung gestellt.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Sämtliche Ereignisse betreffend unserer Stadt kannst du in unserer Bibliothek nachlesen. Leider ging das eigentliche Geschichtsbuch verloren. Aber der Don war so nett und hat uns seine persönlichen Notizen zur Verfügung gestellt.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Wir haben eigentlich keine Gesetze. Du musst nur wissen, dass hier Münzen und deshalb der Don herrscht, weil er die meisten hat. Aber du kannst die Empfehlungen des Dons hier and den Statuen finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Die Quelle der Träume ist am anderen Ende der Stadt. Daher rein mit dir, passiere den Markt und die Villa Goldader und du bist dort. Aber Leute meiden diesen Ort normal. *grinst*")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Die Werkstatt ist auf der linken Seite auf dem Weg zur der Straße zur Malachitmine. Sie ist ein Ort für Schmiede und andere Handwerker.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Galmairs Krone ist das Herz von Galmair und die Residenz unseres Don. Der Eingang ist gleich hinter mir und du findest dort drinnen: Guiliannis Residenz, Dons Konzil Kammer, Goldträume, Schatzkammer und Bibliothek.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Die Schlackengrube befindet sich unter uns. Du musst den Aufzug verwenden um hinunter zu kommen. Du findest folgende Schächte dort: Taverne zur Geflügelten Sau, Schimmersenke, Schweinebaue, Gemmenschacht und Abwasserschächte.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Der Aufzug wird dir helfen hinunter in die Schlackengrube zu kommen. Von dort hast du Zugang zu allen Schächten in der Schlackengrube. Du kannst den Aufzug etwas weiter westlich von hier finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Hinterland")
talkEntry:addConsequence(consequence_inform("[Schlüsselwörter] Gasthof zum schläfrigen Bujhaar, Zensusbüro, Tollloch, Malachitmine, Waldeck, Stinkender Fischer, Plattform, Dunkellochmine, Ackerland, Kupferbrücke, Schwarzbrücke."))
talkEntry:addResponse("Im sogenannten Hinterland findest du: Gasthof zum schläfrigen Bujhaar, Zensusbüro, Tollloch, Malachitmine, Waldeck, Stinkender Fischer, Plattform, Dunkellochmine, Ackerland, Kupferbrücke and Schwarzbrücke.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Das ist ein Lager für Holzfäller und es liegt sehr nahe am Stadttor. Gleich hinter dem Teleporter. *zeigt in den Norden")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Der Stinkende Fischer ist ein Ort für Fischer und ist stromabwärts von Galmair am Nordufer des Malachitbaches.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Wie ich sagte, du solltest besser die Leute in Galmair fragen. Oder du kommst in zwei oder drei Monaten zurück. Dann sollte ich einige Aufgaben für dich haben.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Iradona")
talkEntry:addTrigger("Goldschein")
talkEntry:addResponse("Ja, das ist mein Name. Über was willst du Informationen?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Es gibt drei Städte: Unsere Stadt Galmair, geführt von unserem reichen Herrscher Don Valerio Guilianni. Dann diese zwei armen Städte Runewick und Cadomyr, geführt von Erzmagier Elvaine Morgan und Königin Rosaline Edwards.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("#me schaudert 'Dieses hässliche Gesicht regiert Cadomyr. Wenn du ihr Haar dem Don bringst wird er das vielleicht mögen.'")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Cadomyr")
talkEntry:addResponse("Verschwende deine Zeit dort nicht, aber wenn du Schneider, Glasbläser, Sandgräber, Goldschmiede oder Edelsteinschleifer suchst, kannst du dort welche finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Adron")
talkEntry:addResponse("Einer der schwachen jüngeren Götter. Du kannst Anhänger in Runewick finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Elara")
talkEntry:addResponse("Eine der schwachen jüngeren Götter. Du kannst Anhänger in Runewick finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Malachin")
talkEntry:addTrigger("Malachín")
talkEntry:addResponse("Einer der schwachen jüngeren Götter. Du kannst Anhänger in Cadomyr finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Sirani")
talkEntry:addResponse("Eine der schwachen jüngeren Götter. Du kannst Anhänger in Cadomyr finden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
