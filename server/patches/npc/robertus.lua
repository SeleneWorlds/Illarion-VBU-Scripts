...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der königliche Baumeister Robertus. Schlüsselwörter: kaufe, verkaufe, Handel, Hallo, Baumeister."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Steinblöcke, Marmor... Ich handele mit allem, was die Arbeiter brauchen.")
...
talkEntry:addConsequence(consequence_inform("[Queststatus] Späte Post II: Du überbringst Robertus die Nachricht von Hector Valerion."))
talkEntry:addConsequence(consequence_quest(108, "=", 4))
...
talkingNPC:addCycleText("Wir könnten eine Säule hier hinzufügen... und da auch...", "We could add a pillar here... and there...")
...
tradingNPC:addNotEnoughMoneyMsg("Das könnt ihr euch nicht leisten.", "You can't afford that.")
tradingNPC:addDialogClosedMsg("Im Namen Ihrer Majestät danke ich.", "In lieu of her Royal Majesty: I thank you.")
tradingNPC:addDialogClosedNoTradeMsg("Bringt bitte mehr Steine.", "Please bring more stones.")
tradingNPC:addWrongItemMsg("Das benötige ich nicht.", "I do not need that.")
