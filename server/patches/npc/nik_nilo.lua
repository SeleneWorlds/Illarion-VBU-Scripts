...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Werkzeug- und Rohstoffhändler 'Big Nik'. Schlüsselwörter: kaufe, verkaufe, Handel, Hallo, Beruf, Gesetze."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("Steine so günstig, dass eure Augen funkeln werden.", "Stones at a price that will make your eyes sparkle!")
...
tradingNPC:addNotEnoughMoneyMsg("Ihr solltet eine Lohnerhöhung beantragen.", "You should try to increase your wage.")
