...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Uriel Urch der Veteran. Schlüsselwörter: Bier, Serinjah, Orks, Echsenmann, Elf."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("Quest: Geschichten und Schwerter gestartet. - Besorge einen Krug, gefüllt mit Bier für Uriel."))
talkEntry:addConsequence(consequence_quest(307, "=", 1))
talkEntry:addResponse("Wisst Ihr was? Bringt mir einen Krug mit Bier und ich erzähl Euch meine Geschichte. - Aber gebt Acht dass Ihr nichts verschüttet!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("Quest: Geschichten und Schwerter - Besorge einen Krug, gefüllt mit Bier für Uriel."))
talkEntry:addResponse("Ich werde die Geschichte nicht erzählen, wenn ich kein Bier habe.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_quest(307, "=", 5))
talkEntry:addResponse("Bei Malachín! Das ganze Dorf wurde abgeschlachtet. Kinder tot und ihre Mütter verbrannt! Ihre Schreie! Ich kann sie nicht vergessen. *er seufzt tief und blickt dich fragend an* Bier?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("Quest: Geschichten und Schwerter abgeschlossen. - Uriel greift nach dem Schwert in seinem Gürtel. Er legt es in deine Hände."))
talkEntry:addConsequence(consequence_item(2701, 1, 655, nil))
talkEntry:addConsequence(consequence_quest(307, "=", 7))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Serinjah")
talkEntry:addResponse("Serinjah? Pah. Ihre Krieger kämpfen mit Stöcken und Steinen. Nichts im Vergleich zur Salkamarischen Legion.")
...
talkEntry:addResponse("Die Serinjah sind nichts weiter als ein undisziplinierter Haufen Barbaren. Am Schlachtfeld hätte Salkamar leichtes Spiel.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Elfen... Deren Männer sehen aus wie Weibsvolk. Sollten sich mal die Haare schneiden.")
...
talkEntry:addResponse("#me zieht eine Augenbraue hoch. 'Das Schöne Volk! - gibt es ein Problem dann warten sie einfach ab und sitzen es aus. Schließlich haben sie ja ausreichend Zeit, nicht wahr?'")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("echse")
talkEntry:addResponse("#me macht ein angewidertes Gesicht. 'Diese Schlangenmonster müffeln ständig nach Fisch. Und das kann ich bei den drei unheiligen Plagen nicht ausstehen!'")
...
talkEntry:addResponse("Einen Gynkesen würde ich nicht einmal anspucken, stände er in Flammen! Die meisten von denen sind sowieso Tiere.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Wart ihr jemals in Salkamar? Eine wunderschöne Stadt.")
...
talkEntry:addResponse("Soviel wie ich gesehen habe, kann nicht ein einziger Gott, dich vor dem Krieg bewahren. Trotzdem, Irmorom und Cherga sind die Götter meines Hauses.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Sie kümmert sich hauptsächlich um die Toten. Viele meiner Freunde sind einen grausamen tot gestorben - am Schlachtfeld. Also ist sie meine erste Wahl sollte ich im Andenken an jene etwas zum Altar tragen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Irmorom ist der Gott des Handels und der Handwerke. Ehrenhaft, von gutem Gemüt... Er mag Recht und Ordnung und schlägt niemals ein gutes Bier aus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Sirani")
talkEntry:addResponse("Hähä - Ich würde mir gern eine Sirani Priesterin zur Frau nehmen. *Er zwinkert dir viel sagend zu.* Sie ist schließlich die Göttin der Liebe und des Vergnügens. Tolle Sache, nicht wahr?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("#me gähnt ausgiebig.", "#me yawns.")
talkingNPC:addCycleText("#me blickt auf das Wappen an seiner Brustplatte, ein sanftes Lächeln umspielt seine Lippen für einen kurzen Moment.", "#me looks at the crest on his chest place, a soft smile playing across his lips.")
