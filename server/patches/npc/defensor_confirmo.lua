...
talkEntry:addConsequence(consequence_quest(526, "=", 15))
talkEntry:addResponse("Ich bin Defensor Confirmo. Um meine Prüfung zu bestehen, finde das Tagebuch 'Die Herrschaft Akaltuts' in der Bibliothek und lies es.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du 'Die Herrschaft Akaltuts' gelesen? Wenn du diese Prüfung nicht bestehst, kommst du nicht weiter.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_quest(526, "=", 16))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Krone."))
talkEntry:addConsequence(consequence_item(225, 1, 699, nil))
talkEntry:addConsequence(consequence_quest(526, "=", 17))
