...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Lotte Silberstreif. Sie verkauft Lotterielose. Schlüsselwörter: Regel, ein Los, fünf Lose, Lotterie, Geld, essen. Sage 'stop' wenn du abbrechen willst."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_chance(2.0))
talkEntry:addConsequence(consequence_inform("[Quest Lotte Silberstreif 1] Bring ihr einen Apfel, um an der Lotterie teilnehmen zu können."))
talkEntry:addConsequence(consequence_quest(672, "=", 10))
...
talkEntry:addTrigger("los")
talkEntry:addCondition(condition_chance(2.0))
talkEntry:addConsequence(consequence_inform("[Quest Lotte Silberstreif 2] Bring ihr fünf Kirschen, um an der Lotterie teilnehmen zu können."))
talkEntry:addConsequence(consequence_quest(672, "=", 20))
...
talkEntry:addTrigger("5 Los")
talkEntry:addTrigger("fünf Los")
talkEntry:addConsequence(consequence_inform("[Lottery] Du hast jetzt fünf Lose. Sage 'Stop' um abzubrechen oder etwas Beliebiges um eine Kugel zu ziehen"))
talkEntry:addConsequence(consequence_quest(672, "=", 2))
talkEntry:addConsequence(consequence_money("-", 5000))
...
talkEntry:addCondition(condition_quest(672, "=", 1))
talkEntry:addTrigger("stop")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du gibst das Los zurück. Kaufe ein neues Los, wenn du noch mal starten willst."))
talkEntry:addConsequence(consequence_money("+", 1000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(75.0))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine weiße Kugel und bekommst zehn Silbermünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 1000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(48.0))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine gelbe Kugel und bekommst 20 Silbermünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 2000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(76.9))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine blaue Kugel und bekommst 50 Silbermünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 5000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(66.7))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine grüne Kugel und bekommst zwei Goldmünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 20000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_language("german"))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst die rote Kugel und bekommst fünf Goldmünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 50000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_quest(672, "=", 2))
talkEntry:addTrigger("stop")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du gibst die Lose zurück. Kaufe ein neues Los, wenn du noch mal starten willst."))
talkEntry:addConsequence(consequence_money("+", 5000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(75.0))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine weiße Kugel und bekommst 50 Silbermünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 5000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(48.0))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine gelbe Kugel und bekommst eine Goldmünze zurück."))
talkEntry:addConsequence(consequence_money("+", 10000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(76.9))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine blaue Kugel und bekommst zwei Goldmünzen und 50 Silber zurück."))
talkEntry:addConsequence(consequence_money("+", 25000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_chance(66.7))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst eine grüne Kugel und bekommst zehn Goldmünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 100000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
...
talkEntry:addCondition(condition_language("german"))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Lotterie] Du ziehst die rote Kugel und bekommst 25 Goldmünzen zurück."))
talkEntry:addConsequence(consequence_money("+", 250000))
talkEntry:addConsequence(consequence_quest(672, "=", 0))
talkEntry:addResponse("#sHauptgewinn! Hauptgewinn! Bei der Lotterie von Galmair wurde ein Hauptgewinn gezogen!")
talkingNPC:addTalkingEntry(talkEntry)
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("ticket")
talkEntry:addConsequence(consequence_inform("[Lotterieinformation] Du kannst dir ein Los mittels 'ein Los' oder fünf Lose mittels 'fünf Lose' kaufen. Anschließend bewirkst du die Ziehung mit jeglichen gesprochenen Wort oder Emote. 'Stop' wird jedoch nicht die Ziehung auslösen, sondern dir dein Geld wieder geben."))
...
talkEntry:addResponse("Einen Altar, der Oldra geweiht ist, findet ihr in Yewdale. Das ist das Dorf in der Nähe von Runewick.")
