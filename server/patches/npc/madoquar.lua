...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Madoquar die Uralte. Schlüsselwörter: Hallo, Quest, Hafen, Menschen, Echsen, Halblinge."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_quest(112, "=", 2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst sechs Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 600))
talkEntry:addConsequence(consequence_quest(112, "=", 3))
...
talkEntry:addConsequence(consequence_quest(112, "=", 4))
talkEntry:addResponse("Diese Eiche kann man nicht einfach fällen... Ich hätte es wissen müssen. Der Geist in ihr ist zu stark. Aber es gibt einen Weg; bringt mir eine Streitaxt, einen Silberbarren und etwas anderes - ich werde euch sagen, was, wenn ihr die anderen Dinge gebracht habt.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(104, "all", ">", 0, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 12 Silberstücke und ein Rubinamulett."))
talkEntry:addConsequence(consequence_money("+", 1200))
talkEntry:addConsequence(consequence_deleteitem(2946, 1, nil))
talkEntry:addConsequence(consequence_deleteitem(104, 1, nil))
talkEntry:addConsequence(consequence_item(67, 1, 599, nil))
...
talkEntry:addCondition(condition_quest(112, "=", 7))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Flasche Elfenwein."))
talkEntry:addConsequence(consequence_item(1318, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(112, "=", 8))
...
talkEntry:addCondition(condition_quest(112, "=", 10))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen Amethystring und einen magischen Amethysten."))
talkEntry:addConsequence(consequence_item(277, 1, 799, nil))
talkEntry:addConsequence(consequence_item(3519, 1, 333, {["gemLevel"] = "1"}))
talkEntry:addConsequence(consequence_quest(112, "=", 11))
...
talkingNPC:addCycleText("Was für ein netter Tag. Ich sollte eine kleine Bergwanderung machen.", "What a nice day it is today. I am prone to walk in the mountains methinks.")
talkingNPC:addCycleText("Äpfel hinterlassen immer so einen angenehmen Geschmack im Mund. Ich frage mich, ob es eine Frucht gibt, die meinem Gaumen noch mehr erquicken kann als ein frischer Apfel.", "Apples leave such a pleasant after taste in my mouth. I wonder if there will ever be a fruit more pleasing to the tongue than a fresh apple.")
...
talkingNPC:addCycleText("Es wird Regen geben. Möge Tanora dieses Land nicht allzu sehr peinigen.", "It seems as though it's about to rain today. Please Tanora do not be cruel to this land.")
