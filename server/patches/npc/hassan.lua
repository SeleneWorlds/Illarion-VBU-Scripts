...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der königliche Fächelwedler Hassan. Schlüsselwörter: Seid gegrüßt, Beruf, Taverne."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Neues Quest] Der Schwätzer von Cadomyr"))
talkEntry:addConsequence(consequence_quest(75, "=", 1))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Hassan wird nun deine Fragen beantworten."))
talkEntry:addConsequence(consequence_deleteitem(2057, 1, nil))
talkEntry:addConsequence(consequence_quest(75, "=", 2))
talkEntry:addConsequence(consequence_rankpoints("+", 2))
...
talkingNPC:addCycleText("Ich hab mal von einer Taverne gehört, die 'Happy Halfling' hieß. 'Happy Hassan', das wäre mal ein Name!", "I heard there's a tavern called 'The Happy Halfling'. I'd prefer 'The Happy Hassan' personally.")
...
talkingNPC:addCycleText("Oh, ich könnte so viele Geheimnisse der Königin ausplaudern, aber ich bin ihr treu ergeben.", "Oh, I could tell you so many secrets of the Queen, but I am loyal to her.")
