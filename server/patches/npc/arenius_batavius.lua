...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Kreuzritter Arenius Batavius. Schlüsselwörter: Hallo, Quest, Beruf, Kreuzritter, Orden, Orks, Kult, Cherga."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Queststatus] Späte Post III: Du überbringst Arenius Batavius die Nachricht von Hector Valerion."))
talkEntry:addConsequence(consequence_quest(108, "=", 7))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst sechs Silberstücke und einen Streitkolben."))
talkEntry:addConsequence(consequence_money("+", 600))
talkEntry:addConsequence(consequence_deleteitem(63, 1, nil))
talkEntry:addConsequence(consequence_item(230, 1, 588, nil))
talkEntry:addConsequence(consequence_quest(104, "=", 10))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 12 Silberstücke und ein versilbertes Langschwert."))
talkEntry:addConsequence(consequence_money("+", 1200))
talkEntry:addConsequence(consequence_item(98, 1, 688, nil))
talkEntry:addConsequence(consequence_quest(104, "=", 25))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 20 Silberstücke und einen albarischen Soldatenhelm."))
talkEntry:addConsequence(consequence_money("+", 2000))
talkEntry:addConsequence(consequence_item(2287, 1, 788, nil))
talkEntry:addConsequence(consequence_quest(104, "=", 29))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 50 Silberstücke, einen magischen Saphir und einen Stahlturmschild."))
talkEntry:addConsequence(consequence_money("+", 5000))
talkEntry:addConsequence(consequence_item(96, 1, 888, nil))
talkEntry:addConsequence(consequence_item(3522, 1, 333, {["gemLevel"] = "1"}))
talkEntry:addConsequence(consequence_quest(104, "=", 32))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst zwei Goldstücke, einen magischen Topas und eine albarische Adeligenrüstung."))
talkEntry:addConsequence(consequence_money("+", 20000))
talkEntry:addConsequence(consequence_item(2367, 1, 988, nil))
talkEntry:addConsequence(consequence_item(3525, 1, 333, {["gemLevel"] = "2"}))
talkEntry:addConsequence(consequence_quest(104, "=", 35))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Akaltut")
talkEntry:addResponse("Akaltut, die Abscheulichkeit! Löscht dessen Existenz aus!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ich bin mir sicher, dass der Unterschlupf des Kults der Salavesh sich in einer Höhle, nordöstlich von hier und südlich des Gasthofes zur Hanfschlinge, befindet.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("#me hält sein reich verziertes Schwert fest in der Hand und schwingt es durch die Luft.", "#me holds his ornate sword firmly with one hand, swinging it idly into the air.")
