...
talkEntry:addResponse("I am Defensor Animus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Animus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "<", 29))
talkEntry:addCondition(condition_language("english"))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "=", 29))
talkEntry:addCondition(condition_quest(529, "=", 0))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 17"))
talkEntry:addConsequence(consequence_quest(528, "=", 30))
talkEntry:addConsequence(consequence_quest(529, "=", 1))
talkEntry:addResponse("I am Defensor Animus, to pass my test you must collect two drow blades.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 17"))
talkEntry:addConsequence(consequence_quest(528, "=", 30))
talkEntry:addConsequence(consequence_quest(529, "=", 1))
talkEntry:addResponse("Ich bin Defensor Animus, um meinen Test zu bestehen musst du zwei Drowschwerter von den Drows, welche hier herum schweifen sammeln.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 1))
talkEntry:addCondition(condition_item(2777, "all", "<", 2, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Do you have two drow blades? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du zwei Drowschwerter? Wenn du diesen Test nicht bestehst kannst du nicht weitergehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 1))
talkEntry:addCondition(condition_item(2777, "all", ">", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a pure air."))
talkEntry:addConsequence(consequence_item(2551, 1, 999, nil))
talkEntry:addConsequence(consequence_deleteitem(2777, 2, nil))
talkEntry:addConsequence(consequence_quest(529, "=", 2))
talkEntry:addResponse("You have passed this test and are awarded a pure air.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(2777, "all", ">", 1, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein reine Luft."))
talkEntry:addConsequence(consequence_item(2551, 1, 999, nil))
talkEntry:addConsequence(consequence_deleteitem(2777, 2, nil))
talkEntry:addConsequence(consequence_quest(529, "=", 2))
talkEntry:addResponse("Du hast den Test bestanden. Du bekommst ein reine Luft.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Infirmo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Infirmo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Animus.", "This is Defensor Animus.")
