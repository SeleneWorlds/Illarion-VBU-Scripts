...
talkEntry:addResponse("I am Defensor Extremus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Extremus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(530, "<", 22))
talkEntry:addCondition(condition_language("english"))
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 22"))
talkEntry:addConsequence(consequence_quest(530, "=", 23))
talkEntry:addResponse("I am Defensor Extremus. To pass my test, which is your final test, you must kill three drow leaders.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 22"))
talkEntry:addConsequence(consequence_quest(530, "=", 23))
talkEntry:addResponse("Ich bin Defensor Extremus. Um meine Prüfung zu bestehen, töte drei Drowanführer.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(530, ">", 22))
talkEntry:addCondition(condition_quest(530, "<", 26))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Have you killed the three drow leaders? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du die drei Drowanführer getötet? Wenn du diese Prüfung nicht bestehst, kommst du nicht weiter.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a drow bow."))
talkEntry:addConsequence(consequence_item(2739, 1, 866, {["descriptionEn"] = "Spiderwebs are etched along the front of the bow, with the symbol of Akaltut embedded deeply into the riser. All carvings sporadically cast a strange glow.", ["descriptionDe"] = "Spinnennetze sind vorn in den Bogen geschnitzt. Das Symbol Akaltuts ist tief im Mittelstück eingelassen. Alle Schnitzereien werfen sporadisch einen merkwürdigen Schimmer.", ["rareness"] = "4"}))
talkEntry:addConsequence(consequence_quest(530, "=", 27))
talkEntry:addResponse("You have passed this and all of our other tests. For your perseverance you are awarded a drow bow.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(530, "=", 26))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein Drowbogen."))
talkEntry:addConsequence(consequence_item(2739, 1, 866, {["descriptionEn"] = "Spiderwebs are etched along the front of the bow, with the symbol of Akaltut embedded deeply into the riser. All carvings sporadically cast a strange glow.", ["descriptionDe"] = "Spinnennetze sind vorn in den Bogen geschnitzt. Das Symbol Akaltuts ist tief im Mittelstück eingelassen. Alle Schnitzereien werfen sporadisch einen merkwürdigen Schimmer.", ["rareness"] = "4"}))
talkEntry:addConsequence(consequence_quest(530, "=", 27))
talkEntry:addResponse("Du hast diese und alle anderen unserer Prüfungen bestanden. Für deine Beharrlichkeit wirst du mit diesem Drowbogen belohnt.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed all of the Defensor's tests. In time, you may face Akaltut.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast alle Tests der Defensoren bestanden. Zur rechten Zeit wirst du Akaltut gegenüberstehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("adventure")
talkEntry:addTrigger("order")
talkEntry:addResponse("You have passed all of the Defensor's tests. In time you, you may face Akaltut.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Extremus.", "This is Defensor Extremus.")
