...
talkEntry:addConsequence(consequence_inform("[Game Help] This NPC is Vallaria Medrota the healer an alchemy teacher. Keywords: recipes, alchemy, book"))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Hilfe")
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Vallaria Medrota die Heilerin und Alchemielehrerin. Schlüsselwörter: Rezepte, Alchemie, Buch"))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Wenn Ihr ein die richtige Herstellung eines Tranks lernen wollt, schaut hier auf die Liste auf meinem Tisch.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ich bin Heilerin und kann Euch einige nützliche Rezepte lehren, wenn Ihr auch ein Alchemist seid.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Erzählt Ihr mir doch was.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Druids are actually rather strange people. Most of them are excellent alchemists, true. But well. They indeed have some mazy ideas: spirits of nature, will of nature and all those things.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("druid")
talkEntry:addResponse("Druiden sind schon ein sonderbarer Schlag. Die meisten von ihnen sind zwar exzellente Alchemisten, aber nun ja. Sie haben doch schon recht wirre Ideen: Naturgeister, Wille der Natur und all sowas.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Oh, was wäre ein Trank doch ohne den Edelsteinstaub - ein Sud! Genau!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("The way you treat it, the way will the sickle treat you.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dieser NPC ist Vallaria Medrota die Heilerin und Alchemielehrerin.", "This NPC is Vallaria Medrota the healer and alchemy teacher.")
