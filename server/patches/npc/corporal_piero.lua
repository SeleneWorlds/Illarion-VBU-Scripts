...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Corporal Piero der Wächter. Schlüsselwörter: Galmair, Runewick, Queen Rosaline."))
talkEntry:addConsequence(consequence_state("=", 0))
talkEntry:addResponse("Ich bin die Wache. Ich be-Wache Leute. Lang lebe die Königin. Danke für deine Hilfe mit den Piraten, Zhambra soll dich schützen.")
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Hilfe")
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Corporal Piero der Wächter. Schlüsselwörter: Abenteuer, Königin Rosaline."))
talkEntry:addConsequence(consequence_state("=", 0))
...
talkEntry:addConsequence(consequence_quest(305, "=", 6))
talkEntry:addConsequence(consequence_treasure(2))
talkEntry:addResponse("Gut gut! Ihr bringt gute Nachricht. Im Namen Cadomyrs will ich Euch danken und diese Karte überreichen. Sie stammt aus der Piratenhand... oh und Tobis meinte ich soll Euch diesen Hut geben.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("aufgabe")
talkEntry:addTrigger("abenteuer")
talkEntry:addConsequence(consequence_inform("'Großartig. Also auf in die Piratenbucht! Arrr, Landratte!'"))
talkEntry:addResponse("Irgendwo in der Piratenbucht treibt sich mein Freund Tobis Vunu herum. Sage ihm das ich Euch sende und er wird sich Euch anvertrauen. Seine Informationen sind ausgesprochen wichtig für die Wache Cadomyrs. Viel Glück.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("In Cadomyr, many praise Zhambra or Malachín!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Malachín! The god of knights and hunters! He's a strong fella, each honest man should praise him! Do you praise him?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Zhambra")
talkEntry:addResponse("Auf dem Schlachtfeld verlasse ich mich auf eine scharfe Klinge und meine engsten Freunde die mir den Rücken decken! Dies ist wofür Zhambra steht. Freundschaft - die über den Tod hinaus geht.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("#me kratzt sich am Nasenrücken.", "#me scratches his nose.")
talkingNPC:addCycleText("#me holt ein Stück Brot aus der Tasche und steckt es sich in den Mund.", "#me takes a piece bread out of his bag and eats it.")
...
talkingNPC:addCycleText("#me kratzt sich unauffällig am Hinterteil.", "#me has a inconspicuous quick scratch of his butt.")
talkingNPC:addCycleText("#me blickt leicht verträumt in den Himmel.", "#me glances up at the sky in slightly dreamy way.")
talkingNPC:addCycleText("#me kaut nachdenklich an den Fingernägeln.", "#me gnaws at his fingernails, a thoughtful gaze on his face.")
...
mainNPC:setLookat("Ein Wächter Cadomyrs. Er ist gut rasiert und blickt stolz in die Ferne.", "A guard of Cadomyr. He's well shaved and glances proudly over the area.")
