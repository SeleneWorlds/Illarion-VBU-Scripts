...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Wilderer Eugene Burton. Schlüsselwörter: Hallo, Quest, Wilderer, Tiere."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_quest(4, "=", 1))
talkEntry:addResponse("Meine Familie ist am verhungern und ohne etwas zu essen überleben wir den Winter nicht. Bitte, könntet ihr bitte in den Elsbaumwald gehen, ein halbes Dutzend Kaninchen jagen und mir ihr Fleisch bringen?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Oh, würdet ihr bitte ein halbes Dutzend Kaninchen im Elsbaumwald jagen gehen? Meine Kinder flehen um etwas zu essen und jeden Tag muss ich sie aufs Neue enttäuschen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(553, "all", ">", 5, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 250 Pfeile."))
talkEntry:addConsequence(consequence_deleteitem(553, 6, nil))
talkEntry:addConsequence(consequence_item(64, 250, 333, nil))
talkEntry:addConsequence(consequence_quest(4, "=", 8))
...
talkEntry:addConsequence(consequence_quest(4, "=", 9))
talkEntry:addResponse("Um den Winter zu überleben braucht man mehr als ein Stück Fleisch. Ich schätze, dass das Fleisch von einem Dutzend Hirsch aus dem Elsbaumwald wenigstens meine Kinder am Leben halten wird. Werdet ihr ihre Leben retten?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Ihr könnt Hirsch im Elsbaumwald finden. Bitte, rettet meine Familie vor dem Verhungern.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(552, "all", ">", 11, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen goldenen Ring, einen Kupferkelch, ein Smaragdamulet und 20 Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 2000))
talkEntry:addConsequence(consequence_deleteitem(552, 12, nil))
talkEntry:addConsequence(consequence_item(235, 1, 666, nil))
talkEntry:addConsequence(consequence_item(1840, 1, 666, nil))
...
talkEntry:addCondition(condition_quest(4, "=", 29))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen Langbogen und 100 vergiftete Pfeile."))
talkEntry:addConsequence(consequence_item(2708, 1, 777, nil))
talkEntry:addConsequence(consequence_item(549, 100, 333, nil))
talkEntry:addConsequence(consequence_quest(4, "=", 30))
...
talkEntry:addCondition(condition_quest(4, "=", 32))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen Rubinring und einen magischen Rubin."))
talkEntry:addConsequence(consequence_item(68, 1, 888, nil))
talkEntry:addConsequence(consequence_item(3521, 1, 333, {["gemLevel"] = "1"}))
talkEntry:addConsequence(consequence_quest(4, "=", 33))
