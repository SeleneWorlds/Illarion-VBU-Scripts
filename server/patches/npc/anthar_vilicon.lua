...
talkEntry:addConsequence(consequence_inform("[Game Help] This NPC is Anthar Vilicon the chancellor. Keywords: Hello, Mission, Chancellor, Cadomyr, Elf."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Hilfe")
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Anthar Vilicon der Kanzler. Schlüsselwörter: Hallo, Mission, Kanzler, Cadomyr, Elf."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Hail! Welcome to the Palace of the Edwards. Do not dare to disrespect the Queen and your life will be a long one.")
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(674, "=", 202))
...
talkEntry:addConsequence(consequence_inform("[The pictures Alberto Dickers] Numila Irunnleh has a reward for you."))
talkEntry:addResponse("Very interesting. I'm sure we can use it. There is no honour for the people from Runewick. I've heard Numila Irunnleh gives pictures away even.")
...
talkEntry:addTrigger("Alberto")
talkEntry:addTrigger("Dicker")
talkEntry:addConsequence(consequence_inform("[Die Gemälde Alberto Dickers] Frag Numila Irunnleh noch nach einer Belohnung."))
talkEntry:addResponse("Das ist gut zu wissen. Wir werden es bei Gelegenheit nutzen. Die Leute in Runewick haben aber auch keine Ehre im Leib. Ich habe gehört Numila Irunnleh verschenkt sogar Bilder.")
talkEntry:addConsequence(consequence_quest(674, "=", 203))
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
talkEntry:addTrigger("Alberto")
talkEntry:addTrigger("Dicker")
talkEntry:addConsequence(consequence_inform("[The pictures Alberto Dickers] You finished the quest."))
talkEntry:addResponse("Very interesting. I'm sure we can use it. There is no honour for the people from Runewick.")
talkEntry:addConsequence(consequence_quest(674, "=", 203))
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
talkEntry:addTrigger("Alberto")
talkEntry:addTrigger("Dicker")
talkEntry:addConsequence(consequence_inform("[Die Gemälde Alberto Dickers] Du hast das Quest abgeschlossen."))
talkEntry:addResponse("Das ist gut zu wissen. Wir werden es bei Gelegenheit nutzen. Die Leute in Runewick haben aber auch keine Ehre im Leib.")
talkEntry:addConsequence(consequence_quest(674, "=", 203))
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(120, "~=", 0))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
...
talkEntry:addResponse("Your words honour you and the day will come when you can prove your loyalty to the throne by deeds, but this day is not today. Please come back later.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 0))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_chance(5.0))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 1))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Jeden Tag eine gute Tat für Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 1))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 1))
...
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
talkEntry:addConsequence(consequence_quest(120, "=", 60))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 2))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 2))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 3))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 3))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 4))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 4))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 5))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 5))
talkEntry:addCondition(condition_item(852, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a golden ring."))
talkEntry:addConsequence(consequence_deleteitem(852, 1, nil))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen goldenen Ring."))
talkEntry:addConsequence(consequence_deleteitem(852, 1, nil))
talkEntry:addConsequence(consequence_item(235, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 5))
talkEntry:addCondition(condition_item(852, "all", "<", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 6))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 6))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Tasche."))
talkEntry:addConsequence(consequence_deleteitem(2588, 20, nil))
talkEntry:addConsequence(consequence_item(97, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 7))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 7))
talkEntry:addCondition(condition_item(2701, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded 12 silver coins."))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 12 Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 1200))
talkEntry:addConsequence(consequence_deleteitem(2701, 1, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 8))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 8))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Pilzsuppe."))
talkEntry:addConsequence(consequence_deleteitem(148, 15, nil))
talkEntry:addConsequence(consequence_item(2456, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 9))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 9))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 10))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 10))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 11))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 11))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 12))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 12))
talkEntry:addCondition(condition_item(336, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded seven silver coins."))
talkEntry:addConsequence(consequence_money("+", 700))
talkEntry:addConsequence(consequence_deleteitem(336, 1, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
talkEntry:addConsequence(consequence_quest(120, "=", 60))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst sieben Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 700))
talkEntry:addConsequence(consequence_deleteitem(336, 1, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 12))
talkEntry:addCondition(condition_item(336, "all", "<", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 13))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
talkEntry:addResponse("I have an important order: Queen Rosaline will welcome a delegation from Sevenhill, a dwarven kingdom. She wants to impress those bearded wretches with a special present: A comb for their shaggy beards. It is your duty to select a proper comb and bring it to me.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 13))
talkEntry:addCondition(condition_item(2719, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a pipe."))
talkEntry:addConsequence(consequence_deleteitem(2719, 1, nil))
talkEntry:addConsequence(consequence_item(2744, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
talkEntry:addConsequence(consequence_quest(120, "=", 60))
talkEntry:addResponse("Ha! That comb will suit those bearded wretches. Here, you should relax now, have this pipe, get some pipe weed and enjoy the rest of the day.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 13))
talkEntry:addCondition(condition_item(2719, "all", "<", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 14))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
talkEntry:addConsequence(consequence_quest(119, "=", 14))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
talkEntry:addResponse("Ich bin auch für die Waffenkammer Cadomyrs verantwortlich. Neulich trat Horatio Milenus, eine der Stadtwachen, an mich heran und bat um die Anschaffung eines Langbogens um das Getier der Wüste fernzuhalten. Ich befehle nun euch, einen Langbogen zu beschaffen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 14))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst acht Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 800))
talkEntry:addConsequence(consequence_deleteitem(2708, 1, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 15))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 15))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 16))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 16))
talkEntry:addCondition(condition_item(554, "all", ">", 4, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded 22 silver coins."))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 22 Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 2200))
talkEntry:addConsequence(consequence_deleteitem(554, 5, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 17))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 17))
talkEntry:addCondition(condition_item(843, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a topaz."))
talkEntry:addConsequence(consequence_deleteitem(843, 1, nil))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 17))
talkEntry:addCondition(condition_item(843, "all", "<", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 18))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 18))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 19))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 19))
...
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New Quest] Do a good turn daily for Cadomyr"))
talkEntry:addConsequence(consequence_quest(119, "=", 20))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
talkEntry:addResponse("Today, I have a personal request rather than an order. Could you please bring me a gold ingot - I want to forge a special gift, a bracelet, for my Queen to prove my loyalty.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_quest(119, "=", 20))
talkEntry:addConsequence(consequence_quest(159, "=", 36))
talkEntry:addResponse("Heute habe ich keinen Befehl für euch sondern eine persönliche Bitte. Könntet ihr mir bitte einen Goldbarren bringen - ich möchte der Königin ein besonderes Geschenk, einen Armreif, schmieden um ihr meine Ergebenheit zu beweisen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 20))
talkEntry:addCondition(condition_item(236, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
...
talkEntry:addConsequence(consequence_deleteitem(236, 1, nil))
talkEntry:addConsequence(consequence_quest(119, "=", 0))
talkEntry:addConsequence(consequence_quest(159, "=", 0))
talkEntry:addConsequence(consequence_quest(120, "=", 60))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(119, "=", 20))
talkEntry:addCondition(condition_item(236, "all", "<", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Out of my sight and do not dare to come back before you brought me a gold ingot.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Aus meinen Augen und wagt es nicht eher wiederzukommen, als dass ihr nicht einen Goldbarren dabei habt.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Runewick consists of some small islands in the ocean, deemed to be the most beautiful places in these lands, second only to the palace of the Edwards.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Runewick")
talkEntry:addResponse("Runewick besteht aus einigen kleinen Inseln im Meer, die schönsten Orte in diesen Landen, nur noch in den Schatten gestellt durch den Palast der Edwards.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Zhambra is the god of loyalty. And I am loyal to my Queen and her family, the Edwards'. I've been in their services longer than a dozen human lives.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
