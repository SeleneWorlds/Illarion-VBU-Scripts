...
talkEntry:addResponse("I am Defensor Transfodio.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Transfodio.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 20"))
talkEntry:addConsequence(consequence_quest(529, "=", 8))
talkEntry:addResponse("I am Defensor Transfodio, to pass my test you must kill 18 drow.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 20"))
talkEntry:addConsequence(consequence_quest(529, "=", 8))
talkEntry:addResponse("Ich bin Defensor Transfodio, um meinen Test zu bestehen musst du 18 Drow töten, welche diese Hallen durchstreifen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, ">", 7))
talkEntry:addCondition(condition_quest(529, "<", 26))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Have you killed the 18 drow? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du 18 Drow getötet? Wenn du den Test nicht bestehst kannst du nicht weitergehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded 250 silver coins."))
talkEntry:addConsequence(consequence_money("+", 25000))
talkEntry:addConsequence(consequence_quest(529, "=", 27))
talkEntry:addResponse("You have passed this test and are awarded 250 silver coins.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 26))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 250 Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 25000))
talkEntry:addConsequence(consequence_quest(529, "=", 27))
talkEntry:addResponse("Du hast den Test bestanden. Du bekommst 250 Silberstücke.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 27))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Volnus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Volnus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Transfodio.", "This is Defensor Transfodio.")
