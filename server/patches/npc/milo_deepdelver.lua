...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Kräuterkundige Milo Deepdelver. Er weiß ein paar Dinge über die Götter und Kräuterkunde. Auch scheint er ein Problem mit seinem Ochsen zu haben."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Mission")
talkEntry:addTrigger("Quest")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst zehn Alraunen und eine Flasche Elfenwein."))
talkEntry:addConsequence(consequence_deleteitem(2493, 10, nil))
talkEntry:addConsequence(consequence_item(1318, 1, 333, nil))
talkEntry:addConsequence(consequence_item(752, 10, 333, nil))
talkEntry:addConsequence(consequence_quest(106, "=", 2))
...
talkEntry:addTrigger("Mission")
talkEntry:addTrigger("Quest")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Deine Fertigkeit in Kräuterkunde wurde gesteigert."))
talkEntry:addConsequence(consequence_skill(Character.herblore, "+", 1))
talkEntry:addConsequence(consequence_deleteitem(2493, 10, nil))
talkEntry:addConsequence(consequence_quest(106, "=", 2))
