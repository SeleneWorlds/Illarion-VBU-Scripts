...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Bre Southstar die Torwächterin. Schlüsselwörter: Hallo, Gava, Galmair, Wache."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Gava ist eindeutig zu groß für ein Weib.")
...
talkEntry:addResponse("Gava sagt immer, ich solle alles für Frieden und Gerechtigkeit tun. Ich sage ihr immer, sie solle alles mit Freude und der Sonne im Herzen tun.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Männer sind alle so wie der Don. Die Männer in der Bürgerwehr wollen alle immer nur mit mir Dienst schieben und bei mir sein. Das nervt!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Waffe")
talkEntry:addResponse("Gava brachte mir bei, mit dem Morgenstern umzugehen. Ich übte jeden Tag, bis ich die zweitbeste in der Bürgerwehr damit war.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ich könnte euch eine Menge über meine Schwester Gava erzählen!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Cadomyr")
talkEntry:addResponse("Ich habe Gava dazu gebracht, mir zu versprechen, dass wir dort mal hingehen. Sie meinte, dass wir das an ihrem nächsten freien Tag machen. Das war vor zwei Jahren.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("Nun, ihr kennt ja die Geschichten über Recht und Unrecht. Gava glaubt sogar daran.", "Well you know those stories about right and wrong. Gava is one of the ones who believes in them.")
...
talkingNPC:addCycleText("Ich wünschte, Galvin wäre manchmal etwas besser gelaunt.", "I wish Gava would lighten up every now and then.")
