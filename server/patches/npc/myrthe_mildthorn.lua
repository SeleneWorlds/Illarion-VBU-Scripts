...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist das Waschweib Myrthe Mildthorn. Schlüsselwörter: Hallo, Wäsche, Höhle, Quest."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Eine Höhle im Wald I"))
talkEntry:addConsequence(consequence_item(391, 1, 399, nil))
talkEntry:addConsequence(consequence_quest(79, "=", 1))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Eine Höhle im Wald II"))
talkEntry:addConsequence(consequence_quest(79, "=", 13))
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst zehn Silberstücke und eine gelbe Robe."))
talkEntry:addConsequence(consequence_money("+", 1000))
talkEntry:addConsequence(consequence_item(195, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(79, "=", 19))
talkEntry:addConsequence(consequence_rankpoints("+", 3))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Eine Höhle im Wald III"))
talkEntry:addConsequence(consequence_quest(79, "=", 20))
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Novizenrobe."))
talkEntry:addConsequence(consequence_item(547, 1, 799, nil))
talkEntry:addConsequence(consequence_quest(79, "=", 22))
talkEntry:addConsequence(consequence_rankpoints("+", 3))
