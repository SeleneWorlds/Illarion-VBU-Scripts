...
talkEntry:addResponse("I am Defensor Venenatus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Venenatus.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "<", 18))
talkEntry:addCondition(condition_language("english"))
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 12"))
talkEntry:addConsequence(consequence_quest(527, "=", 19))
talkEntry:addResponse("I am Defensor Venenatus, to pass my test you must collect four drow helms.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 12"))
talkEntry:addConsequence(consequence_quest(527, "=", 19))
talkEntry:addResponse("Ich bin Defensor Venenatus, um meinen Test zu bestehen musst du vier Drowhelme von den Drows, welche hier herum schweifen sammeln.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 12"))
talkEntry:addConsequence(consequence_quest(527, "=", 19))
talkEntry:addResponse("Ich bin Defensor Venanatus,um meinen Test zu bestehen musst du vier Drowhelme von den Drows, welche hier herum schweifen sammeln.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "=", 19))
talkEntry:addCondition(condition_item(2303, "all", "<", 4, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Do you have four drow helms? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du vier Drowhelme? Wenn du diesen Test nicht bestehst kannst du nicht weitergehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "=", 19))
talkEntry:addCondition(condition_item(2303, "all", ">", 3, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded 200 silver coins."))
talkEntry:addConsequence(consequence_money("+", 20000))
talkEntry:addConsequence(consequence_deleteitem(2303, 4, nil))
talkEntry:addConsequence(consequence_quest(527, "=", 20))
talkEntry:addResponse("You have passed this test and are awarded 200 silver coins.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(2303, "all", ">", 3, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 200 Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 20000))
talkEntry:addConsequence(consequence_deleteitem(2303, 4, nil))
talkEntry:addConsequence(consequence_quest(527, "=", 20))
talkEntry:addResponse("Du hast den Test bestanden. Du bekommst 200 Silberstücke.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "=", 20))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Torrens.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Torrens.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Venenatus.", "This is Defensor Venenatus.")
