...
talkEntry:addResponse("I am Defensor Infirmo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Infirmo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "<", 2))
talkEntry:addCondition(condition_language("english"))
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 18"))
talkEntry:addConsequence(consequence_quest(529, "=", 3))
talkEntry:addResponse("I am Defensor Infirmo. To pass my test you must return a Hellhound that is loose, wandering these halls, to its pit. Look at the scroll on the podium by me, to see its last known location.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 18"))
talkEntry:addConsequence(consequence_quest(529, "=", 3))
talkEntry:addResponse("Ich bin Defensor Infirmo. Um meine Prüfung zu bestehen, bringe den entlaufenen Höllenhund, der irgendwo in diesen Hallen herumstreunt, zurück zu seiner Grube. Lese die Schriftrolle auf dem Podium an meiner Seite, um seinen zuletzt bekannten Aufenthaltsort zu erfahren.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 3))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Have you returned the Hellhound? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du den entlaufenen Höllenhund zurückgebracht? Wenn du diese Prüfung nicht bestehst, kommst du nicht weiter.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 4))
talkEntry:addCondition(condition_language("english"))
...
talkEntry:addConsequence(consequence_quest(529, "=", 5))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(529, "=", 5))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Diluo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Diluo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Infirmo.", "This is Defensor Infirmo.")
