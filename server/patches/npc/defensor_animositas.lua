...
talkEntry:addConsequence(consequence_quest(525, "=", 1))
talkEntry:addResponse("Ich bin Defensor Animositas. Um meine Prüfung zu bestehen, nenne mir den Namen des ersten Toten einer Gruppe von Abenteurern, die vor langer Zeit hier durchkamen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_money("+", 5000))
talkEntry:addConsequence(consequence_quest(525, "=", 2))
talkEntry:addResponse("Ja, die Magierin starb als erste. Du hast den Test bestanden. Du bekommst 50 Silberstücke.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_quest(525, "=", 1))
talkEntry:addTrigger(".*")
talkEntry:addResponse("Wie lautet der Name des ersten Abenteurers, der starb? Du musst dies wissen, um meine Prüfung zu bestehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
