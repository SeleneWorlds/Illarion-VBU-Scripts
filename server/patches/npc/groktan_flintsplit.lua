...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Groktan Flintsplit der 'Erinnerer'. Schlüsselwörter: Erinnerer, Don Valerio Guilianni, Quest, Götter, Schulden, Geld."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_quest(107, "=", 1))
talkEntry:addResponse("Japp, ich hätte einen Handlangerdienst. Bring' mir fünf Seile, du weißt, wofür. Frag nicht! Bring sie ran und alles ist gut, bring sie nicht und ich werde dich an sie... 'erinnern'.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Die Erinnerung II: Du hast eine Nachricht für Miggs erhalten."))
talkEntry:addConsequence(consequence_quest(107, "=", 3))
...
talkEntry:addCondition(condition_town(3))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst fünf Silberstücke und einen roten Zauberhut."))
talkEntry:addConsequence(consequence_money("+", 500))
talkEntry:addConsequence(consequence_item(358, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(107, "=", 5))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Die Erinnerung III: Du hast eine Nachricht für Bruno Blackhole erhalten."))
talkEntry:addConsequence(consequence_quest(107, "=", 6))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Die Erinnerung IV: Du hast eine Nachricht für Fronita Emery erhalten."))
talkEntry:addConsequence(consequence_quest(107, "=", 9))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Die Erinnerung V: Du hast eine Nachricht für Königin Rosaline Edwards erhalten."))
talkEntry:addConsequence(consequence_quest(107, "=", 12))
...
talkEntry:addCondition(condition_town(3))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein Eisvogelamulett."))
talkEntry:addConsequence(consequence_item(334, 1, 999, nil))
talkEntry:addConsequence(consequence_quest(107, "=", 14))
talkEntry:addConsequence(consequence_rankpoints("+", 3))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Runewick")
talkEntry:addResponse("Runewick ist keine Stadt, sondern ein Witz. Ich meine, wer ist so dämlich und baut eine Stadt im Ozean?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Brágon gave us the flame... my tinderbox does as well. Do I pray to my tinderbox!?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
