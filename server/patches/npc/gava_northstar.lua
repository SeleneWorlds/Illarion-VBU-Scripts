...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Gava Northstar, die Brückenwächterin. Schlüsselwörter: Hallo, Brücke, Galmair, Wache."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Gava Northstar. Ich bewache die Brücke.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
