...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Tobis Vunu der Pirat. Schlüsselwörter: Abenteuer, Götter."))
talkEntry:addConsequence(consequence_state("=", 0))
...
talkEntry:addConsequence(consequence_inform("Tobis Vunu reicht dir ein Bündel Kleidung und einen Schlapphut. Du sollst alles anziehen und das Tabakfeld suchen um es mit einer Fackel unbemerkt zu zerstören."))
...
talkEntry:addConsequence(consequence_inform("Du hast ein paar Münzen bekommen. Frage nun nach der geheimen Bootschaft die zu Corpotal Piero gebracht werden soll."))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("murgo")
talkEntry:addResponse("Auch unter den Flaggen von uns Piraten ist der Ork Murgo bestens bekannt. Man sagt, er könne einen Baum mit seinen bloßen Händen entwurzeln!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("Eh, du hass nich ne Flasche Rum übrich oder?", "Eh you got a bottle of rum?")
talkingNPC:addCycleText("Dreizehn Mann saßen auf einem Sarg, Ho! Ho! Ho! - Sie soffen drei Tage, der Schnaps war stark. - Ho! Ho! Ho!", "We're drinking rum all night long.- Ho! Ho! Ho! The waves are high, the wind is strong.- Ho! Ho! Ho!")
talkingNPC:addCycleText("Sie liebten das Meer und den Schnaps und das Gold. Ho! Ho! Ho! - Bis einst alle dreizehn n' Dämon holt. - Ho! Ho! Ho!", "We are the lords of the sea. - Ho! Ho! Ho! Drink rum and beer, but never tea.- Ho! Ho! Ho!")
