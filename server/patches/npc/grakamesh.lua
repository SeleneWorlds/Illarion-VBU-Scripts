...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Schamane Grakamesh. Schlüsselwörter: Greebas, Quest, Gruft, Spuk, Sir Reginald."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst zehn Silberstücke und einen Schädelstab."))
talkEntry:addConsequence(consequence_money("+", 1000))
talkEntry:addConsequence(consequence_item(39, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(78, "=", 19))
talkEntry:addConsequence(consequence_rankpoints("+", 3))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine braune Priesterrobe."))
talkEntry:addConsequence(consequence_item(2416, 1, 799, nil))
talkEntry:addConsequence(consequence_quest(78, "=", 22))
talkEntry:addConsequence(consequence_rankpoints("+", 3))
...
talkingNPC:addCycleText("Ich werd tanzen, weiter für alten Oomie Häuptling.", "Mes gottur dance more so old oomie chief hab peace again.")
