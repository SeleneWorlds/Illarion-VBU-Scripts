...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Marianne Forgeron die magische Schmiedin. Schlüsselwörter: Edelstein, Schmieden, Beruf, Grüße."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Seid jegrüßt. Willste datt ich deine magischen Edelsteine kombinieren tu? Datt is nämlich mein Job.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Möge Irmorom mit dir sein!")
talkEntry:addResponse("Möge Irmorom dich beschützen!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse(" Marianne Forgeron, so heiße ich.")
talkEntry:addResponse(" Marianne Forgeron.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(701, "=", 10))
talkEntry:addCondition(condition_item(73, "all", ">", 0, {["nameDe"] = "Echt großer Fisch"}))
talkEntry:addTrigger("Zassaria")
talkEntry:addTrigger("lizzard")
...
talkEntry:addTrigger("groß")
talkEntry:addConsequence(consequence_quest(701, "=", 11))
talkEntry:addResponse("Nee, datt glaub' ich nich'. Der Fisch is' ja tatsächlich riesig. Bitte sagt der Dame Riverbank, es tut mir leid, datt ich sie 'ne Lügnerin nannte.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Cherga")
talkEntry:addResponse("Ich bete nich' zu der. Weiß' du datt etwa nich'?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Elara")
talkEntry:addResponse("I bete nich' zu der. Weiß' du datt etwa nich?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Irmorom")
talkEntry:addResponse("Ich bete nur zu dem. Weiß' du datt etwa nich?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ich hörte der lebt in Runewick.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Elvaine")
talkEntry:addTrigger("Morgan")
talkEntry:addResponse("Ich hörte der lebt auch in Runewick, wie dieser Erzmagier.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ich versteh nicht warum die se ne Königin nennen. Ne' zwergische Königin is jang anders drauf.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("rosaline")
talkEntry:addTrigger("edwards")
talkEntry:addResponse("Ich versteh nicht warum die se' ne Königin nennen. Ne' zwergische Königin is janz anders drauf.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Cadomyr")
talkEntry:addResponse("Wenn ich dich Cadomiy sagen hör, dann denk ich an von'ner Sonne verbrannte Haut... Igitt!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Gobaith")
talkEntry:addTrigger("Gobiath")
talkEntry:addResponse("Hab ich nix von gehört.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
