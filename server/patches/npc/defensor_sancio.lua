...
talkEntry:addResponse("I am Defensor Sancio.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Sancio.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(525, "<", 22))
talkEntry:addCondition(condition_language("english"))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(525, "=", 22))
talkEntry:addCondition(condition_quest(526, "=", 0))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 5"))
talkEntry:addConsequence(consequence_quest(526, "=", 1))
talkEntry:addConsequence(consequence_quest(525, "=", 23))
talkEntry:addResponse("I am Defensor Sancio, to pass my test you must collect six elvenswords.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 5"))
talkEntry:addConsequence(consequence_quest(526, "=", 1))
talkEntry:addConsequence(consequence_quest(525, "=", 23))
talkEntry:addResponse("Ich bin Defensor Sancio. Um meinen Test zu bestehen musst du sechs Elfenschwert von den Drows, welche hier herum schweifen sammeln.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(526, "=", 1))
talkEntry:addCondition(condition_item(2778, "all", "<", 6, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Do you have six elvenswords? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du sechs Elfenschwert? Wenn du diesen Test nicht bestehst kannst du nicht weitergehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded ten venison dishes."))
talkEntry:addConsequence(consequence_item(554, 10, 999, nil))
talkEntry:addConsequence(consequence_deleteitem(2778, 6, nil))
talkEntry:addConsequence(consequence_quest(526, "=", 2))
talkEntry:addResponse("You have passed this test and are awarded ten venison dishes.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(2778, "all", ">", 5, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst zehn Wildgerichte mit Beilage."))
talkEntry:addConsequence(consequence_item(554, 10, 999, nil))
talkEntry:addConsequence(consequence_deleteitem(2778, 6, nil))
talkEntry:addConsequence(consequence_quest(526, "=", 2))
talkEntry:addResponse("Du hast den Test bestanden. Du bekommst zehn Wildgerichte mit Beilage.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Mando.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Mando.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Sancio.", "This is Defensor Sancio.")
