...
talkEntry:addResponse("I am Defensor Fervor.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Fervor.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "<", 24))
talkEntry:addCondition(condition_language("english"))
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 15"))
talkEntry:addConsequence(consequence_quest(528, "=", 25))
talkEntry:addResponse("I am Defensor Fervor. To pass my test you must tell me the name of this mountain range we are in.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 15"))
talkEntry:addConsequence(consequence_quest(528, "=", 25))
talkEntry:addResponse("Ich bin Defensor Fervor. Um meine Prüfung zu bestehen, nenne mir den Namen des Gebirges in dem wir und befinden.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "=", 25))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("Border")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a black cultist robe."))
talkEntry:addConsequence(consequence_item(2378, 1, 699, nil))
talkEntry:addConsequence(consequence_quest(528, "=", 26))
talkEntry:addResponse("You have passed this test and are awarded a black cultist robe.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "=", 25))
talkEntry:addTrigger("Grenz")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Schwarzkultrobe zuerkannt."))
talkEntry:addConsequence(consequence_item(2378, 1, 699, nil))
talkEntry:addConsequence(consequence_quest(528, "=", 26))
talkEntry:addResponse("Du hast den Test bestanden. Du bekommst eine Schwarzkultrobe zuerkannt.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("What is the name of this mountain range? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "=", 25))
talkEntry:addTrigger(".*")
talkEntry:addResponse("Wie lautet der Name dieses Gebirges? Wenn du diese Prüfung nicht bestehst, kommst du nicht weiter.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(528, "=", 26))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Transmutatio.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Transmutatio.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Fervor.", "This is Defensor Fervor.")
