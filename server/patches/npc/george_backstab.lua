...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist George Backstab der Gefangene. Schlüsselwörter: Gefängnis, befreien, Tür, Flucht."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Verschwende keine Zeit, sondern öffne die Tür und befreie mich.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Lass mich nicht alleine hier! Öffne die Tür wenigstens!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Schlecht natürlich. Wie würdest du dich fühlen, wenn du eingeperrt wärst?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("George Backstab und nun öffne die Tür!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Bitte befreie mich aus diesem Gefängnis durch das öffnen der Tür. Die halten mich gefangen, obwohl ich nichts getan habe.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Gefängnis")
talkEntry:addResponse("Ich will nicht mehr länger in diesem Gefängnis sein. Öffne die Tür und lass mich flüchten.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Hilf mir bei meiner Flucht durch das öffnen dieser Tür und ich werde dir auch helfen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("In meiner Position können mir nur noch Nargun und Ronagan helfen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ein Bastard wie die beiden anderen. Er will mich nicht frei sehen und lässt mich immer wieder einfangen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Runewick")
talkEntry:addResponse("Von mir zu dir, die sind dümmer als es erlaubt ist.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ein Bastard wie die beiden anderen. Sie will mich nicht frei sehen und lässt mich immer wieder einfangen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Cadomyr")
talkEntry:addResponse("Glaub mir. Die größten Feiglinge, die es je gegeben hat.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Kannst du die Tür bitte öffnen?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("George")
talkEntry:addTrigger("Backstab")
talkEntry:addResponse("Oh, du kennst meinen Namen. Kannst du die Tür bitte öffnen?")
talkingNPC:addTalkingEntry(talkEntry)
end
talkingNPC:addCycleText("#s Die kommen, die kommen! Öffne meine Tür und ich helfe dir beim Überleben!", "#s They are coming, they are coming. Open the door and I will help you to survive!")
