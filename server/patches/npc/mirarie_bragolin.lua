...
talkEntry:addCondition(condition_quest(317, ">", 14))
...
talkEntry:addConsequence(consequence_inform("[Game Help] This NPC is Mirarie Bragolin, the dwarven explorer. Keywords: Quest, Mission, Adventure, Tell something, Profession."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addTrigger("Hilfe")
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Mirarie Bragolin, die zwergische Entdeckerin. Schlüsselwörter: Quest, Mission, Abenteuer, erzähl was, Beruf."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 0))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New quest] Writing History I"))
talkEntry:addConsequence(consequence_quest(317, "=", 1))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Geschichte schreiben I"))
talkEntry:addConsequence(consequence_quest(317, "=", 1))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 1))
...
talkEntry:addConsequence(consequence_quest(317, "=", 2))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst dreißig Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 3000))
talkEntry:addConsequence(consequence_deleteitem(2496, 5, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 2))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 2))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New quest] Writing history II: You receive a message for Thomas Dalenus."))
talkEntry:addConsequence(consequence_quest(317, "=", 3))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Geschichte schreiben II: Du hast eine Nachricht für Thomas Dalenus erhalten."))
talkEntry:addConsequence(consequence_quest(317, "=", 3))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 4))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
...
talkEntry:addConsequence(consequence_quest(317, "=", 5))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
talkEntry:addConsequence(consequence_money("+", 5000))
talkEntry:addConsequence(consequence_item(92, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 5))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 5))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New quest]  Writing history III: You receive a message for Grakamesh."))
talkEntry:addConsequence(consequence_quest(317, "=", 6))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Geschichte schreiben III: Du hast eine Nachricht für Grakamesh erhalten."))
talkEntry:addConsequence(consequence_quest(317, "=", 6))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 7))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a chain mail."))
talkEntry:addConsequence(consequence_item(101, 1, 677, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 8))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein Kettenhemd."))
talkEntry:addConsequence(consequence_item(101, 1, 677, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 8))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 8))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New quest]  Writing history IV: You receive a message for William Daloire."))
talkEntry:addConsequence(consequence_quest(317, "=", 9))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Writing history IV: Du hast eine Nachricht für William Daloire erhalten."))
talkEntry:addConsequence(consequence_quest(317, "=", 9))
...
talkEntry:addTrigger("Adventure")
talkEntry:addTrigger("Message")
talkEntry:addConsequence(consequence_inform("[New quest] Geschichte schreiben IV: You receive a message for William Daloire."))
talkEntry:addConsequence(consequence_quest(317, "=", 9))
talkEntry:addResponse("I need more information for writing my book. I heard that there is a merchant selling herbs? In Runewick, who could tell me about the climate there. Would you go and ask for me, my friend?")
talkingNPC:addTalkingEntry(talkEntry)
end
...
talkEntry:addTrigger("Botschaft")
talkEntry:addTrigger("Nachricht")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Geschichte schreiben IV: Du hast eine Nachricht für William Daloire erhalten."))
talkEntry:addConsequence(consequence_quest(317, "=", 9))
talkEntry:addResponse("Ich brauche mehr Informationen um mein Buch zu schreiben. In Runewick lebt ein Kräuterhändler, der mir wohl etwas über das Klima sagen kann. Mein Freund, wirst du für mich dort hingehen und fragen?")
talkingNPC:addTalkingEntry(talkEntry)
end
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 10))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded eighty silver coins."))
talkEntry:addConsequence(consequence_money("+", 8000))
talkEntry:addConsequence(consequence_quest(317, "=", 11))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst achtzig Silberstücke."))
talkEntry:addConsequence(consequence_money("+", 8000))
talkEntry:addConsequence(consequence_quest(317, "=", 11))
talkEntry:addConsequence(consequence_rankpoints("+", 3))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 11))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[New quest]  Writing history V: You receive a message for the Don of Galmair, Valerio Guilianni."))
talkEntry:addConsequence(consequence_quest(317, "=", 12))
talkEntry:addConsequence(consequence_talkstate("end"))
talkEntry:addResponse("Hello my friend, thanks for your help. This message is really important. It's for the Don of Galmair. I heard that he proposed to the Queen of Cadomyr. I need to know more about this, it is interesting stuff to write about.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addConsequence(consequence_inform("[Neues Quest] Geschichte schreiben V: Du hast eine Nachricht für den Don von Galmair, Valerio Guilianni erhalten."))
talkEntry:addConsequence(consequence_quest(317, "=", 12))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(317, "=", 13))
talkEntry:addCondition(condition_language("english"))
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest solved] You are awarded a fire dagger."))
talkEntry:addConsequence(consequence_item(2742, 1, 666, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 14))
talkEntry:addConsequence(consequence_rankpoints("+", 4))
talkEntry:addResponse("So, you got an answer? I see... that's just amazing! By the Gods! Your story will fill a whole chapter in the book. Oh, here, this is for you, my friend, and thanks again.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_item(2742, 1, 666, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 14))
talkEntry:addResponse("So, you got an answer? I see... that's just amazing! By the Gods! Your story will fill a whole chapter in the book. Oh, before I forget, here, this is for you, my friend, and thanks again.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen Feuerdolch."))
talkEntry:addConsequence(consequence_item(2742, 1, 666, nil))
talkEntry:addConsequence(consequence_quest(317, "=", 14))
talkEntry:addConsequence(consequence_rankpoints("+", 4))
