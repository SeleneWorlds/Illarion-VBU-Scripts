...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Arenameister Manuel Salan. Schlüsselwörter: Hallo, Monster, Kämpfen, Rangliste, Punkte."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Grüße! Es ist Zeit das du dich in der Arena von Runewick beweist!")
...
talkEntry:addResponse("Wenn es ihn nicht gäbe... Ich kann mir gar nicht ausmalen, was dann aus Runewick werden würde.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Schreib deine eigene Geschichte, indem du in meiner Arena kämpft.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Gegen welches Biest willst du heute kämpfen?")
talkEntry:addConsequence(consequence_arena("request"))
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
talkEntry:addResponse("#me zeigt dir ein Stück Pergament: 'Schau selbst, wer die Besten hier sind.'")
talkEntry:addConsequence(consequence_arena("list"))
talkingNPC:addTalkingEntry(talkEntry)
end
do
...
talkEntry:addTrigger("monster")
talkEntry:addResponse("Es gibt viele Biester, die das Land durchstreifen, wie du sicher weißt. Ich habe ein paar gefunden und gefangen, damit du gegen sie kämpfen kannst.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Nimm dich vor Drachen in Acht! Sie sind gemein und stark und nur ein sehr guter Kämpfer kann ihn schlagen. Es gibt Feuerdrachen, Eisdrachen und untote und jeder ist gemeiner als der andere.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("#mes prunkvolle Rüstung zeigt das Wappen von Runewick.", "#me's shining armour shows the coat of arms of Runewick.")
