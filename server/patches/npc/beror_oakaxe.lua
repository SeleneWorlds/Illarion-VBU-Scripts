...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist Beror Oakaxe der königliche Wachtmeister. Schlüsselwörter: Hallo, Quest, Befehle, Ritter, Tor."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Ich bin der königliche Wachtmeister Beror Oakaxe. Und ja, ich bin ein Zwerg. Ein zorniger Zwerg!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du hast deine Vertrauenswürdigkeit bewiesen."))
talkEntry:addConsequence(consequence_quest(111, "=", 3))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein Bier."))
talkEntry:addConsequence(consequence_item(1909, 1, 333, nil))
talkEntry:addConsequence(consequence_quest(111, "=", 6))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Zange."))
talkEntry:addConsequence(consequence_deleteitem(2588, 20, nil))
talkEntry:addConsequence(consequence_item(2140, 1, 599, nil))
talkEntry:addConsequence(consequence_quest(111, "=", 8))
talkEntry:addConsequence(consequence_rankpoints("+", 1))
talkEntry:addResponse("Rekrut! Stell dir mal vor, wir würden belagert werden und du brauchst wieder so lange, um ein paar gewöhnliche Ziegel zu besorgen! Nimm diese Zange, damit du nächstes mal schneller bist!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen albarischen Soldatenhelm."))
talkEntry:addConsequence(consequence_item(2287, 1, 699, nil))
talkEntry:addConsequence(consequence_quest(111, "=", 11))
talkEntry:addConsequence(consequence_rankpoints("+", 2))
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Der Grundstein der Aufrichtigkeit ist eine Mine im Süden, der Blutkreis die Arena dieses Landes, die nördliche Brücke über den Kantabifluss ist im Norden und deine Patroullie sollte dich auch an die Ostgrenze führen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein Paar albarische Stahlschuhe."))
talkEntry:addConsequence(consequence_item(771, 1, 699, nil))
talkEntry:addConsequence(consequence_quest(111, "=", 14))
talkEntry:addConsequence(consequence_rankpoints("+", 2))
...
talkEntry:addResponse("Being a knight means more than swinging a sword. Fostering one's home requires hard labour, too. Cadomyr is short on wood supply, as you might know. Please provide twenty naldor wood boards for the upkeep of the Malachín temple.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_quest(111, "=", 15))
talkEntry:addResponse("Ein Ritter zu sein verlangt mehr als ein Schwert zu schwingen. Die Heimat zu hegen erfordert auch harte Arbeit. Cadomyr mangelt es bekanntermaßen an Holzlieferungen. Bring mir bitte zwanzig Naldorholzbretter für die Wartung des Malachíntempels.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_quest(111, "=", 17))
talkEntry:addResponse("Ich habe neue Befehle der Königin. Sie verlangt nach wertvollen Kunstwerken der besten Artisanen Cadomyrs um damit einen albarischen Botschafter zu beeindrucken. Bring mir bitte ein Eisvogelamulett und eine Vase. Für die Ehre von Cadomyr!")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_item(20, 1, 999, {["descriptionEn"] = "This shield bears the crest of Cadomyr.", ["descriptionDe"] = "Dieser Schild trägt das Wappen Cadomyrs.", ["rareness"] = "3"}))
...
talkEntry:addCondition(condition_town(1))
talkEntry:addTrigger(".*")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen Ritterschild und einen magischen Amethysten."))
talkEntry:addConsequence(consequence_deleteitem(334, 1, nil))
talkEntry:addConsequence(consequence_deleteitem(315, 1, nil))
talkEntry:addConsequence(consequence_item(20, 1, 999, {["descriptionEn"] = "This shield bears the crest of Cadomyr.", ["descriptionDe"] = "Dieser Schild trägt das Wappen Cadomyrs.", ["rareness"] = "3"}))
talkEntry:addConsequence(consequence_item(3519, 1, 333, {["gemLevel"] = "2"}))
...
talkEntry:addResponse("Ich bin der königliche Wachtmeister. Hab ich das nicht eben schon gesagt!?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dieser NPC ist Beror Oakaxe der königliche Wachtmeister.", "This NPC is Beror Oakaxe the royal sergeant.")
