...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Leichenbestatter Gregor Remethar. Schlüsselwörter: Hallo, Quest, Leichenbestatter, Gruft, Kammern, Wert des Lebens."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Mein Name ist Gregor Remethar, es freut mich, mich mit Euch - noch - unterhalten zu können.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Flasche Lampenöl."))
talkEntry:addConsequence(consequence_item(469, 1, 333, nil))
talkEntry:addConsequence(consequence_quest(105, "=", 1))
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst ein Stück Wachs."))
talkEntry:addConsequence(consequence_item(431, 1, 333, nil))
talkEntry:addConsequence(consequence_quest(105, "=", 1))
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Kerze."))
talkEntry:addConsequence(consequence_item(43, 1, 333, nil))
talkEntry:addConsequence(consequence_quest(105, "=", 1))
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst eine Fackel."))
talkEntry:addConsequence(consequence_item(391, 1, 333, nil))
talkEntry:addConsequence(consequence_quest(105, "=", 1))
...
talkEntry:addCondition(condition_town(2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst einen Keks."))
talkEntry:addConsequence(consequence_item(453, 1, 333, nil))
talkEntry:addConsequence(consequence_quest(105, "=", 1))
...
talkingNPC:addCycleText("Drei Schicksale und ich bin der Schätzer; was wird wohl euer Schicksal sein?", "Three fates and I am the judge. What will become of your fate?")
