...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Arenameister Angelo Rothman. Schlüsselwörter: Hallo, Monster, Kämpfen, Rangliste, Punkte."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkingNPC:addCycleText("#me hält seine reich verzierte Axt fest in der Hand und schwingt sie durch die Luft", "#me holds his ornate axe firmly with one hand, swinging it idly through the air.")
