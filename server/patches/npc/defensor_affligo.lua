...
talkEntry:addResponse("I am Defensor Affligo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("Name")
talkEntry:addResponse("Ich bin Defensor Affligo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(526, "<", 29))
talkEntry:addCondition(condition_language("english"))
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(526, "=", 29))
talkEntry:addCondition(condition_quest(527, "=", 0))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addConsequence(consequence_inform("[New quest] Akaltut's Chamber 9"))
talkEntry:addConsequence(consequence_quest(526, "=", 30))
talkEntry:addConsequence(consequence_quest(527, "=", 1))
talkEntry:addResponse("I am Defensor Affligo, to pass my test you must collect one drow armour.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addConsequence(consequence_inform("[Neue Quest] Die Kammer von Akaltut 9"))
talkEntry:addConsequence(consequence_quest(526, "=", 30))
talkEntry:addConsequence(consequence_quest(527, "=", 1))
talkEntry:addResponse("Ich bin Defensor Affligo, um meinen Test zu bestehen musst du ein Drowrüstung von den Drows, welche hier herum schweifen sammeln.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "=", 1))
talkEntry:addCondition(condition_item(2402, "all", "<", 1, nil))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("Do you have a drow armour? If you do not pass this test you can't continue.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Hast du ein Drowrüstung? Wenn du diesen Test nicht bestehst kannst du nicht weitergehen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "=", 1))
talkEntry:addCondition(condition_item(2402, "all", ">", 0, nil))
talkEntry:addCondition(condition_language("english"))
...
talkEntry:addConsequence(consequence_deleteitem(2402, 1, nil))
talkEntry:addConsequence(consequence_quest(527, "=", 2))
...
do
local talkEntry = talk.talkNPCEntry()
talkEntry:addCondition(condition_quest(527, "=", 2))
talkEntry:addCondition(condition_language("english"))
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addTrigger("test")
talkEntry:addResponse("You have passed, please see Defensor Profligo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("mission")
talkEntry:addTrigger("Test")
talkEntry:addResponse("Du hast bestanden. Gehe zum Defensor Profligo.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
mainNPC:setLookat("Dies ist Defensor Affligo.", "This is Defensor Affligo.")
