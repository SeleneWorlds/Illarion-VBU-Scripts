...
talkEntry:addConsequence(consequence_inform("[Spielhilfe] Dieser NPC ist der Einsiedler Raban. Schlüsselwörter: Hallo, Quest, Sichel, Kräuter."))
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addResponse("Möge Ushara euren Weg begleiten.")
...
talkEntry:addResponse("Raban.")
talkEntry:addResponse("Ich bin ein alter Mann, ohne Bedarf für einen Namen. Die Bäume und Pflanzen haben ihre eigene Bezeichnung für mich. Ihr könnt mich hingegen Raban nennen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_quest(674, "=", 2))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Die Gemälde Alberto Dickers] Du bekommst ein Wolfsfarn und ein Eisblatt. Gehe zurück nach Runewick und bring sie Numila Irunnleh."))
talkEntry:addResponse("Danke, auch wenn wir uns nicht so gut verstehen, zu diesem Wort steht der Erzmagier. Ich habe hier zwei seltene Kräuter. Bringt sie bitte Numila Irunnleh und sagt ihr, dass ich ihr für die Nachricht danke. Und schaut euch ruhig den Hahn an. Man könnte meinen er kräht gleich.")
talkEntry:addConsequence(consequence_item(768, 1, 399, nil))
talkEntry:addConsequence(consequence_item(760, 1, 399, nil))
talkEntry:addConsequence(consequence_quest(674, "=", 3))
talkingNPC:addTalkingEntry(talkEntry)
...
talkEntry:addConsequence(consequence_item(126, 1, 399, nil))
talkEntry:addConsequence(consequence_quest(66, "=", 1))
talkEntry:addResponse("So, so, ihr wollt mir und dem Wald also helfen? Nehmt doch diese Sichel und bringt mir zehn Sprösslinge von den Tannen des Hains.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(149, "all", ">", 9, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst fünf Silberstücke und deine Kräuterkundefertigkeit steigt."))
talkEntry:addConsequence(consequence_skill(Character.herblore, "+", 1))
talkEntry:addConsequence(consequence_money("+", 500))
talkEntry:addConsequence(consequence_deleteitem(149, 10, nil))
talkEntry:addConsequence(consequence_quest(66, "=", 2))
talkEntry:addResponse("Habt besten Dank für die Tannensprösslinge. Nehmt diese glänzenden Scheiben, ich habe keinen Bedarf an ihnen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Und, wie kommt ihr voran mit dem Finden von zehn Tannensprösslinge?")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(147, "all", ">", 19, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst zehn Silberstücke und deine Kräuterkundefertigkeit steigt."))
talkEntry:addConsequence(consequence_skill(Character.herblore, "+", 1))
talkEntry:addConsequence(consequence_money("+", 1000))
talkEntry:addConsequence(consequence_deleteitem(147, 20, nil))
talkEntry:addConsequence(consequence_quest(66, "=", 4))
...
talkEntry:addConsequence(consequence_quest(66, "=", 5))
talkEntry:addResponse("Es ehrt euch, dass ihr mir und der Göttin erneut helfen wollt. Nun benötige ich fünf Champignons, um Leben auf dem Erdboden zu sähen.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addConsequence(consequence_deleteitem(163, 5, nil))
talkEntry:addConsequence(consequence_quest(66, "=", 6))
talkEntry:addResponse("Ah, ihr habt die fünf Champignons mitgebracht. Lange habe ich diese Belohnung aufbewahrt, nun ist sie euer.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addTrigger("quest")
talkEntry:addTrigger("mission")
talkEntry:addResponse("Sucht nach den fünf Champignons in den Pilzkreisen, die ihr nahe der Bäume findet.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
...
talkEntry:addCondition(condition_item(726, "all", ">", 9, nil))
talkEntry:addTrigger(".+")
talkEntry:addConsequence(consequence_inform("[Quest gelöst] Du erhältst 20 Silberstücke und deine Kräuterkundefertigkeit steigt."))
talkEntry:addConsequence(consequence_skill(Character.herblore, "+", 1))
talkEntry:addConsequence(consequence_money("+", 2000))
talkEntry:addConsequence(consequence_deleteitem(726, 10, nil))
talkEntry:addConsequence(consequence_quest(66, "=", 8))
...
talkEntry:addResponse("Mit einer Sichel könnt ihr Tannensprösslinge schneiden um neue Bäume zu pflanzen. Wenn ihr mir dabei helfen wollt, fragt mich nach einem Auftrag.")
talkingNPC:addTalkingEntry(talkEntry)
end
do
local talkEntry = talk.talkNPCEntry()
